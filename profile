...
if [ "$HOSTNAME" = thinkxtreme ]; then
    ...
    alias wiki='source $HOME/pyvenv/wiki-agent/bin/activate'
...
alias more=less
alias tmux='tmux -u'
alias tmux3wide='tmux select-layout even-horizontal'
alias tmux3split='tmux select-layout "60c6,256x72,0,0{132x72,0,0,16,123x72,133,0[123x35,133,0,58,123x36,133,36,17]}"'

alias rvaspout='mkdir -p vasp_old_out && mv ML_* WAVECAR CHGCAR vasp.ctrl vasp.h5 vaspout.h5 vasp.pg1 vasprun.xml vasp.lock XDATCAR PROJCAR PCDAT OUTCAR OSZICAR LOCPROJ IBZKPT EIGENVAL DOSCAR CONTCAR STOPCAR REPORT ICONST HILLSPOT PROCAR CHG conv_imp* observables_imp* H_imp* vaspwave.h5 vaspgamma.h5 TAUCAR wannier90.win wannier90.wout wannier90_u.mat wannier90_u_dis.mat wannier90.nnkp wannier90.mmn wannier90_hr.dat wannier90.eig wannier90.chk wannier90_band.labelinfo.dat wannier90_band.kpt wannier90_band.gnu wannier90_band.dat wannier90.amn wannier90_wsvec.dat vasp_old_out/ 2>/dev/null'
